...
[![Version](https://img.shields.io/badge/version-1.0.5-blue.svg)](#) [![License](https://img.shields.io/badge/license-MIT-green.svg)](#)
...
```yaml
# yaml-language-server: $schema=https://raw.githubusercontent.com/leoweyr/todo-requirement-blueprint-spec/master/schemas/v1.0.5/trb.schema.json
...
The rigorous JSON Schema enforcing these rules is located at `schemas/v1.0.5/trb.schema.json`.
