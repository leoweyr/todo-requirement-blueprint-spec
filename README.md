...
```yaml
# yaml-language-server: $schema=https://raw.githubusercontent.com/leoweyr/todo-requirement-blueprint-spec/master/schemas/v1.0.4/trb.schema.json
...
The rigorous JSON Schema enforcing these rules is located at `schemas/v1.0.4/trb.schema.json`.
